    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-v1-auth-refresh">POST api/v1/auth/refresh</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-GETapi-v1-auth-me">
                                <a href="#authentication-GETapi-v1-auth-me">GET api/v1/auth/me</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-DELETEapi-v1-admin-users--id-">DELETE api/v1/admin/users/{id}</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the device requesting the token. Example: <code>My iPhone</code></p>
        </div>
        </form>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-POSTapi-v1-auth-refresh">POST api/v1/auth/refresh</h2>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="authentication-GETapi-v1-auth-me">GET api/v1/auth/me</h2>
...
Must be one of:
<ul style="list-style-type: square;"><li><code>admin</code></li> <li><code>teacher</code></li> <li><code>student</code></li></ul>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost/api/v1/admin/users/architecto" \
    --header "Authorization: Bearer {YOUR_AUTH_KEY}" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost/api/v1/admin/users/architecto"
);
...
<ul style="list-style-type: square;"><li><code>admin</code></li> <li><code>teacher</code></li> <li><code>student</code></li></ul>
                    ...
                    <h2 id="endpoints-DELETEapi-v1-admin-users--id-">DELETE api/v1/admin/users/{id}</h2>
